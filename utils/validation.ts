...
export class ValidationService {
  ...
  static validateChurchName(name: string): ValidationResult {
    if (!name || !name.trim()) {
  ...
  static validateMemberName(name: string): ValidationResult {
    if (!name || !name.trim()) {
  ...
  static validateDescription(description: string, required: boolean = true): ValidationResult {
  ...
  static validateInitialAmount(amount: string | number): ValidationResult {
